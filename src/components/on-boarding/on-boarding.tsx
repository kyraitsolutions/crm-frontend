...
export default function Onboarding() {
  ...
  const onSubmit = async (data: OnboardingFormData) => {
    try {
      ...
      //   // const accounts = accountsRes?.data?.docs;

      //   // if (accounts?.length > 0) {
      //   //   const firstAccountId = accounts[0].id;

      //   //   // ✅ STEP 2: Store account
      //   //   accountStoreManager.setAccounts(accounts);
      //   //   authManager.setAccountId(firstAccountId);

      //   //   // ✅ STEP 3: Redirect with accountId
      //   //   return navigate(DASHBOARD_PATH.getAccountPath(firstAccountId));
      //   // }
      // }
    } catch (error) {
  ...
  // if (user?.onboarding) return <Navigate to="/dashboard" />;
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="w-full bg-primary text-white rounded-xl py-3 hover:bg-green-700"
                >
