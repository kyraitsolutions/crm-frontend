...
export default function Index() {
  ...
  const createTemplate = async () => {
    ...
    try {
      const response = await emailService.createTemplate(
        String(accountId),
        payload,
      );
              ...
              <CardContent className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge
                    ...
                    variant={t.category === "System" ? "secondary" : "default"}
                  >
                    {t.category}
                  </Badge>
                </div>
...
function CreateTemplate({
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await aiService.createTemplateWithAI(
        String(accountId),
        aiPrompt,
      );
        ...
        {mode === Method.USER && (
          <div className="mt-6 space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleSaveManual}>Save Template</Button>
            </div>
          </div>
        )}
      </DialogContent>
