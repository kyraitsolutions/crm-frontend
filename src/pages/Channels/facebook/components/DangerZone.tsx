...
import { SectionHeader } from "@/pages/Channels/whatsapp/components/SectionHeader";
...
export const DangerZone = () => {
  ...
  const { disconnect } = useMetaStore((state) => state);
    ...
    <Card className="border">
      <CardHeader>
        <SectionHeader
          ...
          title="Danger Zone"
          description="Actions here may stop lead capture from this Page."
        />
      </CardHeader>

      <CardContent className="flex items-center justify-between">
        <div>
          <p className="font-medium">Disconnect Facebook</p>
          <p className="text-sm text-muted-foreground">
            Stop receiving leads and Page data through this integration.
          </p>
        </div>
