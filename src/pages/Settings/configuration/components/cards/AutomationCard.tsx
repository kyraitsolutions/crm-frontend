...
const AutomationCard: React.FC<AutomationCardProps> = ({
  ...
  return (
    <div className="group flex items-center justify-between rounded-2xl border border-primary/15 bg-white px-4 py-3 transition-all duration-150 hover:bg-gray-100">
