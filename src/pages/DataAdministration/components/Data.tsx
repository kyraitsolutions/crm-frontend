    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 font-medium">
                <div className="col-span-2 p-5 rounded-2xl border bg-gray-50/10">
                ...
                <div className="bg-yellow-50 border border-yellow-200 p-5 rounded-2xl text-sm flex justify-between items-center">
