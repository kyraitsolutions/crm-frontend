      ...
      <div className="bg-white rounded-xl p-5 mb-4">
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-3">
            <button className="px-4 py-1.5 text-sm bg-blue-100 text-blue-600 rounded">
              Restore
            </button>
            <button className="px-4 py-1.5 text-sm bg-red-100 text-red-600 rounded">
              Delete
            </button>
          </div>
        ...
        <div className="bg-white border rounded-xl mt-2">
          ...
          <table className="w-full text-sm ">
            ...
            <tbody>
              {["Test", "Take 20% offer", "Requirement gathering"].map(
                (name, i) => (
