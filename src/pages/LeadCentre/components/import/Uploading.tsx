        ...
        <div className="p-8">
          ...
          <div className="mt-6 rounded-2xl bg-blue-50 border border-blue-100 p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{uploadStats.status}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="border rounded-2xl p-4 text-center">
              ...
              <h3 className="text-2xl font-bold">{uploadStats.total}</h3>
            </div>
          ...
          <div className="mt-8 border rounded-2xl p-5 bg-gray-50">
            <div className="flex justify-between mb-2">
              <span className="text-gray-600">Processing Leads</span>

              <span className="font-semibold">
                {uploadStats.uploaded + uploadStats.failed} /{" "}
                {uploadStats.total}
              </span>
            </div>
          ...
          <div className="mt-8 flex justify-end">
            <button className="rounded-2xl border border-gray-300 bg-white px-6 py-2 text-gray-700 hover:bg-gray-50">
              Cancel
            </button>
          </div>
        </div>
