      ...
      <div className="flex items-center gap-10">
        ...
        <div className="relative flex h-100 w-95 flex-col rounded-2xl border border-[#d7d9f1] bg-white px-7 py-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-[#111827]">From File</h2>
          </div>
          ...
          <div className="mt-10 text-center">
            ...
            <p className="mt-10 text-sm text-[#5c6b82]">
              ...
              <span className="cursor-pointer text-[#4f46e5]">CSV</span> or{" "}
              <span className="cursor-pointer text-[#4f46e5]">XLSX</span>
            </p>
          </div>
        ...
        <div className="flex h-100 w-95 flex-col rounded-2xl border border-[#d7d9f1] bg-white px-7 py-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold ">From other CRMs</h2>
          </div>
