...
const LeadTags = ({ lead }: { lead: ILead }) => {
    ...
    const [selectedTags, setSelectedTags] = useState<{ label: string; color: string }[]>([]);
    ...
    const handleAddTag = () => {
        ...
        const alreadyExists = selectedTags.some((tag) => tag.label.toLowerCase() === input.toLowerCase());
    ...
    const handleSave = async () => {
        ...
        await updateLeadField(String(accountId), String(lead?.id), "tags" as never, payload
        );
