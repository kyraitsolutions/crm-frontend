...
const Timeline = () => {
    ...
    const timelineData: TimelineItem[] = [
        {
            ...
            date: "19/05/2026",
            title:
                "Attachment added - Screenshot 2025-06-18 153055.png",
            user: "Abhijeet Singh",
            showNote: true,
        },
        {
        ...
        },
        {
            ...
            date: "17/05/2026",
            title:
                "Fax was updated from blank value to jyguftdtfxv weruiywt",
            user: "Abhijeet Singh",
        },
        {
            id: "6",
            ...
            description:
                "Follow-up email sent regarding booking confirmation",
            user: "Abhijeet Singh",
        },
    ];
    ...
    const groupedTimeline = useMemo(() => {
        return timelineData.reduce(
            (
                acc: Record<string, TimelineItem[]>,
                item
            ) => {
                if (!acc[item.date]) {
                    acc[item.date] = [];
