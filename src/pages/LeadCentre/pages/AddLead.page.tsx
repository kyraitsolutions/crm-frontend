...
const AddLead = () => {
  ...
  const { getConfigurations, configurationItems, activeTab } =
  ...
  const generatePayload = () => {
    const custom = customFields.reduce(
      (acc, item) => {
    ...
    <div className="bg-gray-200 p-6">
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-sm">
            Populate the fields below to register a new potential client into
            the system.
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white p-4 rounded">
            <h2 className="font-medium text-gray-600 mb-5 text-lg flex items-center gap-1">
              <Info size={18} className="-mt-0.5 text-violet-600" /> Basic
              Information
            </h2>
            <div className="grid grid-cols-2 gap-4">
              ...
              <p className="flex text-xs text-red-500 font-medium!">
                Must select country code to enable whatspp conversation
              </p>
            </div>
          </div>
          <div className="bg-white p-4 rounded">
          ...
          {/* Lead Details */}
          <div className="bg-white p-4 rounded">
            <h2 className="font-medium mb-5 text-lg flex items-center gap-1 text-gray-600">
              <MessageSquareMore size={16} className="text-primary" /> Lead
              Details
            </h2>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <select
                  name="stage"
                  onChange={handleChange}
                  className="py-2 outline-primary text-sm bg-gray-50 border px-4 rounded"
                >
          ...
          {/* Address */}
          <div className="bg-white p-4 rounded">
            <h2 className="font-medium mb-5 flex text-lg items-center text-gray-600">
              <MdLocationOn size={20} className="-mt-0.5 text-second" /> Address
            </h2>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
          ...
          {/* Notes */}
          <div className="bg-white p-4 rounded">
            <h2 className="font-medium mb-5 text-lg flex items-center gap-1">
              <MdInfo size={20} className="-mt-0.5 text-blue-500" /> Additional
              Details
            </h2>
            <div className="flex flex-col gap-1">
          ...
          <div className="bg-white p-4 border rounded">
            <h2 className="font-medium mb-5 text-lg text-gray-600">Tags</h2>
