        ...
        <div className="space-y-5">
          ...
          <div className="border bg-white p-4 rounded">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-sm" htmlFor="countrycode">
                  Country Code
                </label>
                <input
                  name="countrycode"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <select
                  name="stage"
                  onChange={handleChange}
                  className="py-2 outline-primary bg-gray-100 border px-4 rounded"
                >
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="py-1.5 outline-primary bg-gray-100 border px-4 rounded"
                  onChange={handleChange}
                />
              </div>
            </div>
          ...
          <div className="bg-white p-4 border rounded">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                rows={6}
                className="py-1.5 resize-none outline-primary bg-gray-100 border px-4 rounded w-full"
                onChange={handleChange}
              />
            </div>
          </div>
