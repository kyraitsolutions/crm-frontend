...
const MySubscriptionPage = () => {
  ...
  const planName = subscription?.planId
    ? SubscriptionPlan[subscription.planId as keyof typeof SubscriptionPlan]
    : undefined;
        ...
        <div className="xl:col-span-2 bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="mt-8">
            <div className="flex justify-between mb-2">
              <span className="text-sm text-slate-600">Subscription Usage</span>
            ...
            <div className="flex justify-between mt-2 text-sm text-slate-500 text-sm">
              <span>Started: {startDate?.toLocaleDateString("en-IN")}</span>

              <span>Expires: {expiryDate?.toLocaleDateString("en-IN")}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="border border-slate-200 rounded-xl p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-slate-500 text-sm text-sm">Start Date</p>
            ...
            <div className="border border-slate-200 rounded-xl p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-slate-500 text-sm text-sm">Days Left</p>
            ...
            <div className="border border-slate-200 rounded-xl p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-slate-500 text-sm text-sm">Credits</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="mt-8 rounded-2xl bg-orange-50 border border-orange-200 p-4">
            ...
            <p className="text-sm text-orange-600 mt-1">
              Upgrade your plan to avoid interruption in services.
            </p>
          </div>
